  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>make user interactive Designs</h1>}
          subText={
            <h5>
              we provide quick and fact information to our client
            </h5>
          }
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Develop"
          title={<h1>Develope useful & effective web-app</h1>}
          subText={
            <h5>
              we try to make appropriate solution to you for website & app 
            </h5>
          }
        />
        <OBJ>
      ...
      <Content>
        <TextBlock
          ...
          subText={
            <h5>
              we help our customers to tell about what happened in the world, to know and stand
              out in an increasingly of informative digital world
            </h5>
          }
        />
        <OBJ>
